...
import { ISSUE_SCHEMA_VERSION, type Issue } from '@/server/domain/issue';
...
export async function readWorkingState(
  ...
  const draft = data.site_drafts as
    | { issue?: unknown; issue_schema_version?: number }
    | null;
