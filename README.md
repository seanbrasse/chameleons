...
**Status: Phase 1.** Tenancy, routing, the test harness, template #1 and the
snapshot publish/read path exist. The builder UI does not, so nothing calls
`publishSite` from a form yet.
